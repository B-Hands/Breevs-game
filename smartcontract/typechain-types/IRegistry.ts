...
export interface IRegistryInterface extends Interface {
  getFunction(nameOrSignature: "getAddressFor"): FunctionFragment;
...
export interface IRegistry extends BaseContract {
  ...
  getAddressFor: TypedContractMethod<[identifier: BytesLike], [string], "view">;
